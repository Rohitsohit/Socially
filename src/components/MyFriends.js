...
export default function MyFriends(user) {
  ...
  return (
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>handleprofile(friend.name,friend.MessageID)} height="1.5em" viewBox="0 0 512 512" style={{ marginRight: '99px',borderColor:"red",fill:"#9691ab" }}>
